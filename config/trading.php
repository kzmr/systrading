...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | orderbook:record は trading_settings の全通貨ペアに加えて、ここに列挙した
    | GMO 銘柄コードの板も記録する。'/' を含まない銘柄はそのまま GMO に渡される。
    |
    | BTC_JPY は取引所レバレッジ市場（売買手数料 0、日本時間 6:00 をまたいだ建玉に
    | 0.04%/日）。現物との実質コスト差を判断するために板・スプレッドを蓄積する。
    |
    */
    'orderbook' => [
        'extra_symbols' => ['BTC_JPY'],
    ],
